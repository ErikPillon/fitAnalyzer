...
def app():
    ...
    if selected_file:
        ...
        if df.empty:
            st.warning("No record data found in this activity.")
            return
        ...
        elevation_col = 'enhanced_altitude' if 'enhanced_altitude' in df.columns else 'altitude' if 'altitude' in df.columns else None
